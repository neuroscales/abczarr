...
class OMEImageLabel(OMEImage):
    ...
    It extends [OMEImage][abczarr.ome.v0_6dev1.ome.OMEImage] with
    `image_label`, the [ImageLabel][abczarr.ome.v0_6dev1.labels.ImageLabel]
...
class OMEScene(OME):
    ...
    `scene` is the [Scene][abczarr.ome.v0_6dev1.scenes.Scene] that it
    carries.
    """
