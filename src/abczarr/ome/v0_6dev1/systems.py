...
class Axis(OMEMetadata):
    ...
    [SpaceAxis][abczarr.ome.v0_6dev1.systems.SpaceAxis].
    """
...
class CoordinateSystem(OMEMetadata):
    ...
    by name. `axes` lists its [Axis][abczarr.ome.v0_6dev1.systems.Axis]
    objects in order. That order is the order every coordinate tuple in
    this coordinate system uses. A
    [Dataset][abczarr.ome.v0_6dev1.images.Dataset] or a
