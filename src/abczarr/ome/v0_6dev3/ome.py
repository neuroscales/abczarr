...
class OMEImageLabel(OMEImage):
    ...
    It extends [OMEImage][abczarr.ome.v0_6dev3.ome.OMEImage] with
    `image_label`, the [ImageLabel][abczarr.ome.v0_6dev3.labels.ImageLabel]
...
class OMEScene(OME):
    ...
    `scene` is the [Scene][abczarr.ome.v0_6dev3.scenes.Scene] that it
    carries.
    """
