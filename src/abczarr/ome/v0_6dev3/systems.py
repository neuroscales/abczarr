...
class Axis(OMEMetadata):
    ...
    subclass, such as [SpaceAxis][abczarr.ome.v0_6dev3.systems.SpaceAxis].
...
class CoordinateSystem(OMEMetadata):
    ...
    by name. A [Dataset][abczarr.ome.v0_6dev3.images.Dataset] or a
    ...
    axes : list of Axis
        The system's [Axis][abczarr.ome.v0_6dev3.systems.Axis] objects, in
