...
class Axis(OMEMetadata):
    """One dimension of a
    [Multiscale][abczarr.ome.metadata.v0_4.images.Multiscale] pyramid.

    `name` is the axis's label, such as `"x"` or `"channel"`. Its
    position in a [Multiscale][abczarr.ome.metadata.v0_4.images.Multiscale]'s
    ...
    a [SpaceAxis][abczarr.ome.metadata.v0_4.axes.SpaceAxis], and
