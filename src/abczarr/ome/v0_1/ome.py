...
[OME][abczarr.ome.v0_1.ome.OME] and its subclasses each describe what
...
class OME(OMEBase):
    ...
    [OMEImage][abczarr.ome.v0_1.ome.OMEImage],
    [OMEPlate][abczarr.ome.v0_1.ome.OMEPlate], and
    [OMEWell][abczarr.ome.v0_1.ome.OMEWell] for examples.
...
class OMEImage(OME):
    ...
    multiscales : list of Multiscale
        ...
        [Multiscale][abczarr.ome.v0_1.images.Multiscale] object. An image
...
class OMEImageLabel(OMEImage):
    ...
    Parameters
    ----------
    image_label : list of ImageLabel
...
class OMEPlate(OME):
    ...
    ----------
    plate : Plate
        The [Plate][abczarr.ome.v0_1.plates.Plate] metadata describing
...
class OMEWell(OME):
    ...
    ----------
    well : Well
        The [Well][abczarr.ome.v0_1.wells.Well] metadata describing the
...
class OMEBioformats2Raw(OME):
    ...
    bioformats2raw_layout : int
        ...
        value is always `3`.
    plate : Plate
        The [Plate][abczarr.ome.v0_1.plates.Plate] metadata, present when
