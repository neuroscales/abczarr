...
class OME(OMEBase):
    ...
    [OMEImage][abczarr.ome.v0_6dev2.ome.OMEImage] or
    [OMEPlate][abczarr.ome.v0_6dev2.ome.OMEPlate], is an `OME` object that
...
class OMEImage(OME):
    ...
    [Multiscale][abczarr.ome.v0_6dev2.images.Multiscale] pyramids. `omero`,
...
class OMEImageLabel(OMEImage):
    ...
    An `OMEImageLabel` extends [OMEImage][abczarr.ome.v0_6dev2.ome.OMEImage]
    with `image_label`, the
    [ImageLabel][abczarr.ome.v0_6dev2.labels.ImageLabel] that describes the
...
class OMEPlate(OME):
    ...
    `plate` is the [Plate][abczarr.ome.v0_6dev2.plates.Plate] that describes
...
class OMEWell(OME):
    ...
    `well` is the [Well][abczarr.ome.v0_6dev2.wells.Well] that lists the
...
class OMEBioformats2Raw(OME):
    ...
    [Plate][abczarr.ome.v0_6dev2.plates.Plate] the converted data belongs
    to.
    """
