...
[Multiscale][abczarr.ome.v0_6dev2.images.Multiscale] describes a pyramid of
progressively downsampled resolution levels, placed within one or more
named coordinate systems. Each level is a
[Dataset][abczarr.ome.v0_6dev2.images.Dataset], naming a Zarr array and how
...
class Multiscale(OMEMetadata):
    ...
    that a [Dataset][abczarr.ome.v0_6dev2.images.Dataset] or a
