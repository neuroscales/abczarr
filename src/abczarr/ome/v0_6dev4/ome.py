...
class OMEImageLabel(OMEImage):
    ...
    An `OMEImageLabel` extends [OMEImage][abczarr.ome.v0_6dev4.ome.OMEImage]
    with `image_label`, the
    [ImageLabel][abczarr.ome.v0_6dev4.labels.ImageLabel] that describes the
...
class OMEScene(OME):
    ...
    `scene` is the [Scene][abczarr.ome.v0_6dev4.scenes.Scene] that the
    group carries.
    """
