...
[Multiscale][abczarr.ome.v0_6dev4.images.Multiscale] describes a pyramid of
progressively downsampled resolution levels, placed within one or more
named coordinate systems. Each level is a
[Dataset][abczarr.ome.v0_6dev4.images.Dataset], naming a Zarr array and how
...
class Multiscale(OMEMetadata):
    ...
    coordinateSystems : list of CoordinateSystem
        ...
        that a [Dataset][abczarr.ome.v0_6dev4.images.Dataset] or a
