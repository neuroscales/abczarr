...
class OMEImage(OME):
    ...
    [Multiscale][abczarr.ome.v0_6rc0.images.Multiscale] pyramids. `omero`,
...
class OMEImageLabel(OMEImage):
    ...
    An `OMEImageLabel` extends [OMEImage][abczarr.ome.v0_6rc0.ome.OMEImage]
    with `image_label`, the
    [ImageLabel][abczarr.ome.v0_6rc0.labels.ImageLabel] that describes the
...
class OMEPlate(OME):
    ...
    `plate` is the [Plate][abczarr.ome.v0_6rc0.plates.Plate] that describes
...
class OMEWell(OME):
    ...
    `well` is the [Well][abczarr.ome.v0_6rc0.wells.Well] that lists the
...
class OMEScene(OME):
    ...
    `scene` is the [Scene][abczarr.ome.v0_6rc0.scenes.Scene] that the
    group carries.
    """
...
class OMEBioformats2Raw(OME):
    ...
    [Plate][abczarr.ome.v0_6rc0.plates.Plate] the converted data belongs
    to.
    """
