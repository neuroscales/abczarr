...
class OMEImageLabel(OMEImage):
    ...
    It extends [OMEImage][abczarr.ome.v0_6rc0.ome.OMEImage] with
    `image_label`, the [ImageLabel][abczarr.ome.v0_6rc0.labels.ImageLabel]
...
class OMEScene(OME):
    ...
    `scene` is the [Scene][abczarr.ome.v0_6rc0.scenes.Scene] that it
    carries.
    """
