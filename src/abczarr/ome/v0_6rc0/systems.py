...
class Axis(OMEMetadata):
    ...
    subclass, such as [SpaceAxis][abczarr.ome.v0_6rc0.systems.SpaceAxis].
...
class CoordinateSystem(OMEMetadata):
    ...
    by name. A [Dataset][abczarr.ome.v0_6rc0.images.Dataset] or a
    ...
    axes : list of Axis
        The system's [Axis][abczarr.ome.v0_6rc0.systems.Axis] objects, in
