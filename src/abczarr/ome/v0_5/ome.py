...
[OME][abczarr.ome.v0_5.ome.OME] and its subclasses each describe what
...
class OME(OMEBase):
    ...
    [OMEImage][abczarr.ome.v0_5.ome.OMEImage],
    [OMEPlate][abczarr.ome.v0_5.ome.OMEPlate], and
    [OMEWell][abczarr.ome.v0_5.ome.OMEWell] for examples.
...
class OMEImage(OME):
    ...
    omero : Omero
        ...
        [Omero][abczarr.ome.v0_5.omero.Omero] for the fields it carries.
        Optional.
    """
...
class OMEImageLabel(OMEImage):
    ...
    A label image is an [OMEImage][abczarr.ome.v0_5.ome.OMEImage] whose
