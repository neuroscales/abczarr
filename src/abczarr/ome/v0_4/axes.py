...
class Axis(OMEMetadata):
    """One dimension of a
    [Multiscale][abczarr.ome.v0_4.images.Multiscale] pyramid.

    An axis's position in a
    [Multiscale][abczarr.ome.v0_4.images.Multiscale]'s `axes` list is its
    ...
    [SpaceAxis][abczarr.ome.v0_4.axes.SpaceAxis], and likewise for
