...
class Space(OMEMetadata):
    """Identifies a
    [CoordinateSystem][abczarr.ome.v0_6.systems.CoordinateSystem] that
...
class ByDimension(CoordinateTransformation):
    ...
    class Transformation(OMEMetadata):
        ...
        [ByDimension][abczarr.ome.v0_6.transformations.ByDimension],
