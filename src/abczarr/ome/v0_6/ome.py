...
[OME][abczarr.ome.v0_6.ome.OME] and its subclasses each describe what
...
class OME(OMEBase):
    ...
    [OMEImage][abczarr.ome.v0_6.ome.OMEImage] or
    [OMEPlate][abczarr.ome.v0_6.ome.OMEPlate], is an `OME` object that
...
class OMEImageLabel(OMEImage):
    ...
    Extends [OMEImage][abczarr.ome.v0_6.ome.OMEImage] with the
...
class OMEScene(OME):
    ...
    """The [Scene][abczarr.ome.v0_6.scenes.Scene] the group carries."""
