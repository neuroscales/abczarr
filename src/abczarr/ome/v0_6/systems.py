...
class Axis(OMEMetadata):
    ...
    [CoordinateSystem][abczarr.ome.v0_6.systems.CoordinateSystem].

    Constructing an `Axis` with a recognized `type` returns the matching
    subclass, such as [SpaceAxis][abczarr.ome.v0_6.systems.SpaceAxis].
    """
...
class DisplacementAxis(Axis):
    ...
    [Displacements][abczarr.ome.v0_6.transformations.Displacements]
...
class CoordinateAxis(Axis):
    ...
    The axis labels a dimension of the array that a
    [Coordinates][abczarr.ome.v0_6.transformations.Coordinates]
...
class CoordinateSystem(OMEMetadata):
    ...
    by name. A [Dataset][abczarr.ome.v0_6.images.Dataset] or a
    ...
    """The system's [Axis][abczarr.ome.v0_6.systems.Axis] objects,
