...
class OME(OMEBase):
    ...
    what it holds. See [OMEImage][abczarr.ome.v0_3.ome.OMEImage],
    [OMEPlate][abczarr.ome.v0_3.ome.OMEPlate], and
    [OMEWell][abczarr.ome.v0_3.ome.OMEWell] for examples. The
...
class OMEImage(OME):
    ...
    [Multiscale][abczarr.ome.v0_3.images.Multiscale] object. An
    ...
    [Omero][abczarr.ome.v0_3.omero.Omero] for the fields it carries.
    """
...
class OMEImageLabel(OMEImage):
    ...
    A label image is an [OMEImage][abczarr.ome.v0_3.ome.OMEImage]
    whose pixel values name segments. The `image_label` field
    carries the [ImageLabel][abczarr.ome.v0_3.labels.ImageLabel]
...
class OMELabels(OME):
    ...
    [OMEImageLabel][abczarr.ome.v0_3.ome.OMEImageLabel] object.
    """
...
class OMEPlate(OME):
    ...
    [Plate][abczarr.ome.v0_3.plates.Plate] metadata, which describes
...
class OMEWell(OME):
    ...
    [Well][abczarr.ome.v0_3.wells.Well] metadata, which describes
...
class OMEBioformats2Raw(OME):
    ...
    the [Plate][abczarr.ome.v0_3.plates.Plate] metadata for that
    plate.
    """
