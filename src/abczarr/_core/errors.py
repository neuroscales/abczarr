"""The errors abczarr raises, defined at the bottom of the import graph.

They live in `_core` so any layer -- metadata, the abc surface, the
drivers -- can import them at module top without a cycle. The public
`abczarr.errors` (and the package top level) re-export them.
"""
